          ...
          <div id="shoppage">
            <div style={{width:"350px", paddingLeft:"20px",paddingTop:"20px", fontSize:"11px", fontWeight:"bold"}}>       
             <h5> Search By Category</h5> 
              <br/>
              <input type="radio" value="men" name="cat" onChange={(e)=>{setCatData(e.target.value)}} /> Mens Bracelets
              <br/>
              <input type="radio" value="women" name="cat"  onChange={(e)=>{setCatData(e.target.value)}} /> Womens Bracelets
              <br/>
              <input type="radio" value="kids" name="cat"  onChange={(e)=>{setCatData(e.target.value)}} /> Kids Bracelets
             <br/>
